package com.jar.inlinehook.inlinehookdemothree

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.util.Log
import android.widget.TextView
import com.jar.inlinehook.inlinehookdemothree.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        // Used to load the 'inlinehookdemothree' library on application startup.
        init {
            System.loadLibrary("inline_hook_demo_three")
        }
    }
}